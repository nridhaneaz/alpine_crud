                ...
                <template x-for="product in products" :key="product.id">
                    <tr>
                        ...
                        <td class="p-2 flex gap-2">
                            <button @click="edit(product)" class="edit-btn px-2 py-1 bg-green-500 text-green rounded hover:bg-green-500" data-id="1">Edit</button>
                            <button @click="deleteProduct(product)" class="delete-btn px-2 py-1 bg-red-500 text-red rounded hover:bg-red-500" data-id="1">Delete</button>
                        </td>
                    </tr>
                </template>
            </tbody>
